...
function Register({ setShowSignup, setAuthMode }: RegisterProps) {
  return (
    <div className="fixed inset-0 backdrop-blur-md flex items-center justify-center z-[1000] p-4 overflow-y-auto">
