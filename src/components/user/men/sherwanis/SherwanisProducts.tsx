...
export default function SherwaniProducts() {
  const tag = "Wedding Sherwanis"; // 🔑 change this tag as per your backend
const [filters, setFilters] = useState<{
  ...
  return (
    <div className="flex-1 text-black overflow-y-auto hide-scrollbar h-screen">
      <SectionHeading>Wedding Sherwanis for Men</SectionHeading>
