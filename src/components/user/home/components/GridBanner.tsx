...
export default function GridBanner() {
  return (
    <div className="w-full flex justify-center lg:p-4 p-2">
      <div className="lg:grid lg:grid-cols-12 flex flex-col p-4 lg:gap-4 gap-1 h-auto lg:w-[85%] w-[95%] bg-pink-100 ">
        <div className=" w-full col-span-8 grid grid-cols-12 lg:gap-4 gap-1">
          ...
          <div className="w-full h-full grid grid-rows-2 col-span-6 lg:gap-4 gap-1">
            ...
            <div className=" w-full row-span-1 flex lg:gap-4 gap-1">
        ...
        <div className=" w-full lg:col-span-4 flex flex-col justify-center items-center mt-6">
             ...
             <button className="app-color p-2 mb-8">All Sarees</button>
