...
import FilterBar from "@/components/user/bridal/bridallehanga/components/FilterBar";
import { useDebounce } from "@/lib/hooks/useDebounce";
import { useProducts } from "@/lib/query/tagProductQuery";



export default function IndoProducts() {
  const tag = "Indo Western";
...
const [filters, setFilters] = useState<{
  ...
  return (
    <div className="flex-1 text-black overflow-y-auto hide-scrollbar h-screen">
      <SectionHeading>Indo Western </SectionHeading>
